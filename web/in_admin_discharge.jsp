...
%>
  ...
  <form method="post" action="AdmitDischargeServ">
  <table width="900" border="0" align="center" cellpadding="10" cellspacing="10">
    ...
    <tr>
      <td><div align="right" class="style25">Discharge Date</div></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input name="Submit" type="submit" class="box-orange" id="Submit" value="  Discharge  ">
      </label></td>
    </tr>
  </table>
  </form>
