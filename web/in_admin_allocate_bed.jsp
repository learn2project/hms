...
%>
  ...
  <form method="post" action="AdmitAllocateBedServ">
  <table width="900" border="0" align="center" cellpadding="10" cellspacing="10">
    ...
    <tr>
      <td><div align="right" class="style25">Bed Type</div></td>
      <td><select name="List_Bed" id="List_Bed">
        <%
...
while(rs.next())
{
if((rs.getString("name")).equalsIgnoreCase("--SELECT--"))
{
%>
<option value="<%=rs.getString("name")%>" selected disabled><%=rs.getString("name")%></option>
<%
}
else
{
...
%>
    ...
    <tr>
      <td><div align="right" class="style25"> Start Date</div></td>
     ...
     <tr>
      <td><div align="right" class="style25"> End Date</div></td>
      <td><select name="List_Day1" id="List_Day1">
     <option value="Day" selected disabled> Day </option>
     <%
	  	for (int i=1;i<=31;i++)
		{
	 ...
	 %>
        ...
        <select name="List_Month1" id="List_Month1">
        <option value="1" selected disabled> MONTH </option>
        <option value="Jan"> January </option>
        <option value="Feb"> February </option>
        <option value="Mar"> March </option>
        ...
        <select name="List_Year1" id="List_Year1">
          <option value="Year" selected disabled> Year </option>
          <option value="2012">2012</option>
          <option value="2013">2013</option>
          <option value="2014">2014</option>  
