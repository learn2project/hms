...
%>
  ...
  <table width="962" border="0" align="center" cellpadding="10" cellspacing="10">
    <tr>
    <td width="105" bgcolor="#000099"><div align="center" class="style5">DATE</div></td>
    <td width="218" bgcolor="#000099"><div align="center" class="style5">SUBJECT</div></td>
    <td width="506" bgcolor="#000099"><div align="center" class="style5">CONTENT</div></td>
 ...
 Connection con=DriverManager.getConnection("jdbc:mysql:///hms","root","system");
  String day=request.getParameter("List_Day");
            ...
            PreparedStatement ps=con.prepareStatement("select * from notice where date =(select str_to_date(?,'%d-%M-%Y'))");
            ps.setString(1,d);
    ...
    <tr>
    <form name="form" method="post" action="NoticeDelServ"> 
      <td>
      <div align="center" class="style8">
      <label><%=date %></label>
      </div></td>
      <td><div align="center" class="style8"><label><%=subject %></label></div></td>
      <td><div align="center" class="style2"><label><%=content %></label></div></td>
      <td><div align="center">
          <label>
          <input type="hidden" name="hiddensubject" value="<%=subject%>">
  		<input type="hidden" name="hiddencontent" value="<%=content%>">
          <input type="submit" class="box-orange" value="DELETE">
          </label>
        </div>        </td>
     </form>
    </tr>
    <%		
		...
		if(i==1)
		response.sendRedirect("admin_notice_del.jsp?msg=No Notice For This Date");
	%>
  </table>
