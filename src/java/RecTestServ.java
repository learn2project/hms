 ...
 * @author Roni
 */
public class RecTestServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            stmt=con.prepareStatement("update test set status='yes' where id=?");
            stmt.setInt(1, id);
            stmt.execute();
            response.sendRedirect("test_admin_reactive.jsp?msg=Updated Successfully&id="+id);
        }
                catch(Exception e){
