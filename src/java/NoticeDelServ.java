 ...
 * @author Roni
 */
public class NoticeDelServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           PreparedStatement ps = con.prepareStatement("delete from notice where subject = ? and content = ?");
		   ps.setString(1, subject);
		   ps.setString(2, content);
            ps.executeUpdate();
            response.sendRedirect("admin_notice_del.jsp?msg=Deletion successful");
            }  catch(Exception e){
