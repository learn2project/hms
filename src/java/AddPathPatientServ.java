...
public class AddPathPatientServ extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select max(id) from pathologypatient");
            ...
            ps1.executeUpdate();
          response.sendRedirect("path_admin_add_patient.jsp?msg=Patient Added Successfully&msg1="+id);     
        }  
        catch(Exception e){
                HttpSession session1 = request.getSession(true);
                String msg,page1;
                msg=e.toString();
                page1="path_admin_add_patient.jsp";
