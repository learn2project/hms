...
public class UpdateDocServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int id,age,fee,docid;
            String name,sex,address,email,degree,number;
            docid=Integer.parseInt(request.getParameter("doc_id"));
            ...
            stmt2=con2.prepareStatement("delete from doctor where id=?");
            ...
            stmt1.setInt(10, fee);
            stmt1.executeUpdate();
            response.sendRedirect("doctor_admin_update_doc.jsp?msg=Doctor Updated Successfully");
