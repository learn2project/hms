...
public class DispatchBloodServ extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String group;
           int count=0;
           group=request.getParameter("List_Group");
           ...
           rs.next();
            int count1=rs.getInt("count");
             count1=count1-count;
            PreparedStatement ps1=con1.prepareStatement("update bloodbank set count=? where bloodgroup=?");
            ps1.setInt(1, count1);
            ps1.setString(2, group);
             ps1.executeUpdate();   
           response.sendRedirect("blood_admin_dispatch.jsp?msg=Updated Successfully"); 
        }
    catch(Exception e){
                HttpSession session1 = request.getSession(true);
                String msg,page1;
                msg=e.toString();
                page1="blood_admin_dispatch.jsp";
