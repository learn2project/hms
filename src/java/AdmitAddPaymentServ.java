...
public class AdmitAddPaymentServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float amount=Float.parseFloat(request.getParameter("Text_Amount"));
            ...
            String details=request.getParameter("Text_Details");
            PreparedStatement ps=con.prepareStatement("insert into admitpay values(?,?,(select str_to_date(?,'%d %M %Y')),?,?)");
            ps.setInt(1, pid);
            ...
            ps.executeUpdate();
            response.sendRedirect("in_admin_add_payment.jsp?msg=Payment Added Successfully");  
                ...
                String msg,page1;
                msg=e.toString();
                page1="in_admin_add_payment.jsp";
