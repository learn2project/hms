 ...
 * @author Roni
 */
public class AdmitPatientUpdateServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	    ...
	    String disease=request.getParameter("Text_Disease");
            ...
            PreparedStatement ps1=con.prepareStatement("delete from admitpatient where id=?");
            ps1.setInt(1, id);
            ps1.execute();
            ...
            ps.executeUpdate();
            response.sendRedirect("in_admin_update_patient.jsp?msg=Patient Updated Successfully..&nid=0");
