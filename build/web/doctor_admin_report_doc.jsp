...
var rg=parseInt(str);
window.location.replace("http://localhost:8084/Hospital_Management_System/doctor_admin_report_doc.jsp?id="+did+"&value="+val+"&nid="+rg);
}
</script>
</head>
<body>
...
%>
<form method="post" action="doctor_admin_report_doc1.jsp">
 <%!
...
<table width="600" border="0" align="center" cellpadding="10" cellspacing="10">
  <tr>
    <td width="273"><div align="right" class="style3">Select Department</div></td>
  ...
  <tr>
    <td><div align="right" class="style3">Select Doctor</div></td>
    <td><select name="doc">
    <%
