...
%>
<form method="post" action="DelTestServ">
  <table width="600" border="0" align="center" cellpadding="10" cellspacing="10">
    <tr>
      <td width="255"><div align="right"><span class="style1">Select Test</span></div></td>
      <td width="275"><label>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="button" type="submit" class="box-blue" id="button" value="  DELETE  "></td>
    </tr>
  </table>
  </form>
  <p>&nbsp;</p>
