...
%>
 <table width="950" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    ...
    dd=d+" "+m+" "+y;
	PreparedStatement ps=con.prepareStatement("select pt.patientid,pp.name pname,t.name tname,pt.report from test t, pathologytestdetails pt,pathologypatient pp where pt.date=(select str_to_date(?,'%d %M %Y')) and pt.patientid=pp.id and pt.testid=t.id");
	ps.setString(1,dd);
	String status="";
  ...
  <p>&nbsp;  </p>
  <p align="center"><a href="path_admin_report_date.jsp">Back</a></p>
  <p>
    <%
  }
