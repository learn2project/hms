...
%>
<form method="post" action="AdmitAddExpenseServ">
  <table width="600" border="0" align="center" cellpadding="10" cellspacing="10">
    <tr>
      <td class="style1"><div align="right" >Patient ID</div></td>
      <td>
        <input type="text" name="Text_PId" id="Text_PId">
      </td>
    </tr>
    <tr>
      <td class="style1"><div align="right">Test Name</div></td>
      <td><label>
        ...
        <%
         ...
         %>
                ...
                <option value=<%=pid%> selected disabled><%=pname%></option>
                  <%
            }
			else
			{
